...
// ace - added rogue changes, mainly paranoia stuff (and gravity vector init)
void
G_InitEdict(edict_t *e)
{
	...
	// ace - rogue gravity vector defaults
...
{
	if (!ed)
	{ // ace - rogue paranoia check, debug print might be usefull here
		return;
	}
