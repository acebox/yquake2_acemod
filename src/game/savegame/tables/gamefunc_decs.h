...
extern void berserk_sight ( edict_t * self , edict_t * other ) ;
// ace - a_spawn.c stuff
extern void ace_EnemyScaleUp(void);
extern void ace_EnemyScaleDn(void);
extern void ace_AddItems(void);
extern void ace_MonsterItemRandomizer(edict_t *ent);
extern void ace_SpawnRandomizer(edict_t *ent);
extern void ace_MonsterQuickPopulate (void);
extern void ace_MonsterRandomizerGo (void);